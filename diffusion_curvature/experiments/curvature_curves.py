"""Perhaps comparison curvature is hampered by *time*, which goes faster or slower depending on kernel bandwidth?"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../experiments/02-diffusion-laziness/3a-are-kernels-zeitgeibers.ipynb.

# %% auto #0
__all__ = ['show_curvature_curves']

# %% ../../experiments/02-diffusion-laziness/3a-are-kernels-zeitgeibers.ipynb #e76c1947
import numpy as np
