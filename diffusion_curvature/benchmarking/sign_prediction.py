...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../experiments/04-sadspheres-sign-prediction/5-sign-prediction-tests.ipynb.

# %% auto #0
__all__ = ['dims', 'num_pointclouds', 'method_name', 'run_sadspheres', 'objective', 'optimize_parameters', 'main']

# %% ../../experiments/04-sadspheres-sign-prediction/5-sign-prediction-tests.ipynb #6f7b7f3f
dims = [2, 3, 4, 5, 6]
num_pointclouds = 20

# %% ../../experiments/04-sadspheres-sign-prediction/5-sign-prediction-tests.ipynb #2691060b
...
# %% ../../experiments/04-sadspheres-sign-prediction/5-sign-prediction-tests.ipynb #9220dcdd
import optuna
import os
import math
import numpy as np
...
# %% ../../experiments/04-sadspheres-sign-prediction/5-sign-prediction-tests.ipynb #9ff00dd8
@call_parse
def main(
