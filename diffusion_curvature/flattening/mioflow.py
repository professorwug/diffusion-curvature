...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb.
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #5145d9e0
import os, inspect
import torch
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #9eb74fbf
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #db51e998
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #0900126e
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #896597c5
import os, math, numpy as np
import torch
import torch.nn as nn
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #1633962d
import ot
import torch.nn as nn
import torch
import numpy as np
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #df8b2417
import torch.nn as nn
import torch
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #1b50a050
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #f10c2edd
import itertools
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #ecf4ecb4
import itertools
import torch.nn as nn
from torch.nn  import functional as F 
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #3ad5a531
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #1722b21d
from torchdiffeq import odeint_adjoint as odeint
import os, math, numpy as np
import torch
import torch.nn as nn
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #c5e78607
def make_model(
    feature_dims=5,
    layers=[64],
    output_dims=5,
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #aeff1c80
import graphtools
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #fb5e12a5
# import phate
from scipy.sparse import csr_matrix
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #554d0c1d
import numpy as np
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #21d4d429
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #a0902d91
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #c7c33fc6
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #fc39d562
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #07eb47a9
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #85d565f4
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #43e65fd3
import os, math, numpy as np, pandas as pd
import torch
import torch.nn as nn
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #ae7c9ade
import matplotlib.pyplot as plt
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #6afb9a9e
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #c3e855f3
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #ba81d9cb
import os, math, numpy as np
import torch
import torch.nn as nn
...
class MMD_loss_to_uniform(nn.Module):
    ...
    https://github.com/ZongxianLee/MMD_Loss.Pytorch/blob/master/mmd_loss.py
    '''
    def __init__(self, kernel_mul = 2.0, kernel_num = 5,embedding_dim = 2, batch_size = 1000, use_cuda=torch.cuda.is_available()):
    ...
    def uniformly_sampled_circle(self):
        self.uniformity = 2*torch.rand(self.batch_size,self.embedding_dim)-1
        # restrict to a uniformly sampled circle
        self.uniformity = self.uniformity[torch.linalg.norm(self.uniformity, dim=-1) < 1]
        if self.use_cuda: self.uniformity = self.uniformity.cuda()
    ...
    def forward(self, source):
        ...
        # scale the source points to lie in the unit sphere
        source_mean = torch.mean(source, axis=0)
        source = (source - source_mean)
        source_max = torch.max(torch.linalg.norm(source, dim=-1))
        source = source / source_max
        # perform MMD loss between target and uniform points
        target = self.uniformly_sampled_circle()
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #ddc35ceb
import os, sys, json, math, itertools
import pandas as pd, numpy as np
import warnings
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #802a2df5
# from MIOFlow.plots import plot_comparision, plot_losses
# from MIOFlow.eval import generate_plot_data
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #c1e9d665
import torch, numpy as np
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #9c51a642
import os, math, numpy as np, pandas as pd
import torch
import torch.nn as nn
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #abb9d49e
import matplotlib.pyplot as plt
from matplotlib.patches import Patch
from matplotlib.lines import Line2D
from matplotlib import rcParams, cycler
...
# %% ../../experiments/10-flow-matching-flattening/MIOFlow for Neural Flattening.ipynb #c957e7f2
