...
# %% auto 0
__all__ = ['dims', 'num_pointclouds', 'method_name', 'run_sadspheres', 'objective', 'optimize_parameters']

# %% ../nbs/5-sign-prediction-tests.ipynb 4
dims = [2, 3, 4, 5, 6]
num_pointclouds = 20

# %% ../nbs/5-sign-prediction-tests.ipynb 9
from tqdm.auto import tqdm, trange
from fastcore.all import *
from .kernels import tune_curvature_agnostic_kernel

method_name = "Diffusion Curvature (TN w/ k = 1 adaptive n t 40)"
...
def run_sadspheres():
    ...
    if method_name in SS1.imported_methods:
        return SS1
    for X in tqdm(SS1):
        kernel, ns = tune_curvature_agnostic_kernel(X, 20, tolerance = 5, max_iterations = 100)
