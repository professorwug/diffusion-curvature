...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../experiments/0-basics/0e-Errata.ipynb.

# %% auto #0
__all__ = ['jax_set_best_gpu', 'kronecker_delta', 'plot_3d', 'perform_trials', 'plot_array', 'random_jnparray',
           'visualize_embedding', 'printnum']

# %% ../experiments/0-basics/0e-Errata.ipynb #29262b64
import jax
...
# %% ../experiments/0-basics/0e-Errata.ipynb #8e70cf01
import numpy as np
def kronecker_delta(
...
# %% ../experiments/0-basics/0e-Errata.ipynb #47029ab8
...
# %% ../experiments/0-basics/0e-Errata.ipynb #9b99c5d8
...
# %% ../experiments/0-basics/0e-Errata.ipynb #3e29943e
...
# %% ../experiments/0-basics/0e-Errata.ipynb #24cd5568
# random array in jax
import jax.random
import random
...
# %% ../experiments/0-basics/0e-Errata.ipynb #afd0f7df
import numpy as np
import torch
import matplotlib.pyplot as plt
...
# %% ../experiments/0-basics/0e-Errata.ipynb #a75e830e
def printnum(number):
