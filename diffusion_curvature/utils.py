# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/library/Utils.ipynb.

# %% auto 0
__all__ = ['kronecker_delta', 'plot_3d', 'perform_trials', 'plot_array', 'random_jnparray', 'visualize_embedding', 'printnum']

# %% ../nbs/library/Utils.ipynb 3
import numpy as np
def kronecker_delta(
