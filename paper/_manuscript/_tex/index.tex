...
\author{
Kincaid MacDonald\orcidlink{0009-0006-4686-7488},~Dhananjay
Bhaskar\orcidlink{0000-0002-7859-8394},~Kaly
Zhang\orcidlink{0000-0002-7859-8394},~Ian
Adelstein\orcidlink{0000-0002-7859-8394}
and~Smita Krishnaswamy\orcidlink{0000-0002-7859-8394}%
\thanks{Kincaid MacDonald is with Yale%
  Corresponding author: kincaid@aya.yale.edu
}
%by-author.affiliations
\thanks{Dhananjay Bhaskar is with MILA%
}
%by-author.affiliations
\thanks{Kaly Zhang is with MILA%
}
%by-author.affiliations
\thanks{Ian Adelstein is with Yale Department of Math%
}
%by-author.affiliations
\thanks{Smita Krishnaswamy is with Yale Department of Applied Math%
}
\thanks{Yale School of Medicine}
%by-author.affiliations
}
\begin{document}
...
\begin{IEEEkeywords}
Manifold Learning, Geometric Deep Learning, Graph Curvature, Point
Clouds
\end{IEEEkeywords}
...
Diffusion Maps
{[}\citeproc{ref-maaten2008VisualizingDataUsing}{\textbf{maaten2008VisualizingDataUsing?}}{]}\citeproc{ref-moon2019VisualizingStructureTransitions}{\textbf{moon2019VisualizingStructureTransitions?}}\citeproc{ref-coifman2006DiffusionMaps}{\textbf{coifman2006DiffusionMaps?}},
...
\citeproc{ref-ollivier2009RicciCurvatureMarkov}{\textbf{ollivier2009RicciCurvatureMarkov?}}.
Sturm's \emph{displacement convexity of entropy} (DCE) measures the
proliferation of midpoints in positive curvature
\citeproc{ref-sturm2006GeometryMetricMeasure}{\textbf{sturm2006GeometryMetricMeasure?}}.
...
\citeproc{ref-bhaskarDiffusionCurvatureEstimating2022}{{[}1{]}}, in
which we demonstrated its ability to produce an unsigned magnitude of
curvature estimation for toy datasets and single-cell data, and proved a
...
technique \(PHATE\)
\citeproc{ref-moon2019VisualizingStructureTransitions}{\textbf{moon2019VisualizingStructureTransitions?}}
...
\citeproc{ref-tongDiffusionEarthMover2021}{\textbf{tongDiffusionEarthMover2021?}}
efficiently approximates the transportation distance between
distributions on a graph using multi-scale wavelet transform obtained by
applying different scales of diffusion. \emph{LEGSNet}`s ``learnable
geometric scattering'' computes tunable scales of diffusion with a graph
neural network and achieves state of the art performance on biochemistry
graph classification
\citeproc{ref-tong2020DataDrivenLearningGeometric}{\textbf{tong2020DataDrivenLearningGeometric?}}.
These are but a few of the many manifold learning techniques based in
diffusion.
...
\citeproc{ref-coifman2006DiffusionMaps}{\textbf{coifman2006DiffusionMaps?}}:
...
\bibitem[\citeproctext]{ref-bhaskarDiffusionCurvatureEstimating2022}
\CSLLeftMargin{{[}1{]} }%
\CSLRightInline{D. Bhaskar \emph{et al.}, {``Diffusion curvature for
estimating local curvature in high dimensional data,''} \emph{Advances
in Neural Information Processing Systems}, vol. 35, pp. 21738--21749,
