...
\] \{eq-laziness\} This provides a more sensitive and parameter-free
measure of the `spread' of diffusion.
...
\] \{eq-entropic-definition\} which evokes the use of entropy to measure
heat diffusion.
...
\subsubsection{A Motivating Example: Entropic Diffusion Curvature
Recovers a Bishop-Gromov Volume
...
\subsubsection{Bounding diffusion laziness by Ollivier-Ricci
...
\subsubsection{Comparing Diffusion Across
...
\paragraph{Standard methods of graph construction obscure geometric
...
\paragraph{The Curvature Agnostic
