# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/library/Mean Flat Entropies.ipynb.

# %% auto 0
__all__ = ['average_flat_entropies', 'create_mean_entropy_database', 'load_average_entropies']

# %% ../../nbs/library/Mean Flat Entropies.ipynb 2
...
# %% ../../nbs/library/Mean Flat Entropies.ipynb 3
import h5py
...
# %% ../../nbs/library/Mean Flat Entropies.ipynb 4
import h5py
