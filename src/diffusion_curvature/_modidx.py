  ...
  'syms': { 'diffusion_curvature.benchmarking.hickok': { 'diffusion_curvature.benchmarking.hickok.KDE': ( 'library/benchmarking/hickock-curvature.html#kde',
            ...
            'diffusion_curvature.random_surfaces': { 'diffusion_curvature.random_surfaces.manifold_density': ( 'library/datasets/random-surfaces.html#manifold_density',
                                                     ...
                                                     'diffusion_curvature.random_surfaces.second_fundamental_form': ( 'library/datasets/random-surfaces.html#second_fundamental_form',
                                                                                                                      'diffusion_curvature/random_surfaces.py')},
            'diffusion_curvature.ricci.rays': { 'diffusion_curvature.ricci.rays.DiffusionRays': ( 'library/core-pyg/3a-diffusion-rays.html#diffusionrays',
                                                                                                  'diffusion_curvature/ricci/rays.py'),
                                                'diffusion_curvature.ricci.rays.DiffusionRays.__init__': ( 'library/core-pyg/3a-diffusion-rays.html#__init__',
                                                                                                           'diffusion_curvature/ricci/rays.py'),
                                                'diffusion_curvature.ricci.rays.DiffusionRays.diffusion_distances_to': ( 'library/core-pyg/3a-diffusion-rays.html#diffusion_distances_to',
                                                                                                                         'diffusion_curvature/ricci/rays.py'),
                                                'diffusion_curvature.ricci.rays.DiffusionRays.pointwise_curvature': ( 'library/core-pyg/3a-diffusion-rays.html#pointwise_curvature',
                                                                                                                      'diffusion_curvature/ricci/rays.py'),
                                                'diffusion_curvature.ricci.rays.DiffusionRays.rays': ( 'library/core-pyg/3a-diffusion-rays.html#rays',
                                                                                                       'diffusion_curvature/ricci/rays.py')},
